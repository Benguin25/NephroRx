...
export default function ResultsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 p-8 md:p-12 max-w-md h-screen flex flex-col justify-between pointer-events-none">
        ...
        {/* Analyze Button - Bottom Left */}
        <button 
          onClick={() => navigate("/analysis", { state: { result } })}
          className="pointer-events-auto self-start flex items-center gap-2 bg-[#8B7462]/20 hover:bg-[#8B7462]/30 border border-[#8B7462]/50 text-[#e0cfc2] px-6 py-3 rounded-xl transition-all hover:scale-105 hover:shadow-lg hover:shadow-[#8B7462]/20 text-sm font-light tracking-wide group"
        >
